...
public class ExplosionFacet3 extends SingleSidedFacet {
	...
	ExplosionFacet3(int ii, int jj, int nn, int mm, Appearance fa) {
...
//		if ((1) < t) t = 1;
		...
		MatrixBuilder.euclidean().translate(0,gravity*waveParameter*waveParameter*waveParameter,3*gravity*waveParameter*waveParameter).rotate(Math.PI*waveParameter*angle, axis).assignTo(tmpM);
