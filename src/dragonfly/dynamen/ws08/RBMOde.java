...
//	public double cc = 1;
	private TextSlider.Double speedSlider;
	...
	public void setTimeStep(double timeStep) {
		...
		if (speedSlider != null) speedSlider.setValue(timeStep);
	}
...
//	}
	...
	public Component getInspector() {
		Box insp = Box.createVerticalBox();
		insp.setName("RBMODE");
		speedSlider = new TextSlider.Double(
				"timestep", SwingConstants.HORIZONTAL,0.0,.1,timeStep);
		speedSlider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				timeStep = speedSlider.getValue().doubleValue();
			}
		});		
		insp.add(speedSlider);
		return insp;
