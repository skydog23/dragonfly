...
public class InterlockedTetrahedra  extends Assignment {
	...
	boolean kemper = true, oneTri = true, allTen = true;
	...
	private int numCylinderSides = 2;
...
//		cyl = gmf.mergeIndexedFaceSets(sgc);
//		ThickenedSurfaceFactory tsf = new ThickenedSurfaceFactory(cyl);		// constructor requires a surface
